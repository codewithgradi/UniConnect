        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    BroadcastAtUtc = table.Column<DateTime>(type: "timestamp with time zone", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_InstitutionalEvents_AspNetUsers_CreatedByAdminId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SystemHeadline = table.Column<string>(type: "text", nullable: false),
                    AboutBio = table.Column<string>(type: "text", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Title = table.Column<string>(type: "text", nullable: false),
                    Description = table.Column<string>(type: "text", nullable: false),
                    TargetProgramme = table.Column<string>(type: "text", nullable: false),
                    Status = table.Column<int>(type: "integer", nullable: false),
                    CreatedAtUtc = table.Column<DateTime>(type: "timestamp with time zone", nullable: false)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Opportunities_BusinessProfiles_BusinessProfileId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Recommendations_UserProfiles_AuthorProfileId",
                        column: x => x.AuthorProfileId,
                        principalTable: "UserProfiles",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Recommendations_UserProfiles_TargetProfileId",
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<Guid>(type: "uuid", nullable: false),
                    UserSkillUserProfileId = table.Column<Guid>(type: "uuid", nullable: false),
                    UserSkillSkillId = table.Column<Guid>(type: "uuid", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_SkillEndorsements_AspNetUsers_EndorsedByUserId",
                        column: x => x.EndorsedByUserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_SkillEndorsements_UserSkills_UserSkillUserProfileId_UserSki~",
                        columns: x => new { x.UserSkillUserProfileId, x.UserSkillSkillId },
                        principalTable: "UserSkills",
                        principalColumns: new[] { "UserProfileId", "SkillId" },
                        onDelete: ReferentialAction.Cascade);
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_InstitutionalEvents_CreatedByAdminId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Opportunities_BusinessProfileId",
                table: "Opportunities",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Recommendations_AuthorProfileId",
                table: "Recommendations",
                column: "AuthorProfileId");

            migrationBuilder.CreateIndex(
                name: "IX_Recommendations_TargetProfileId",
                table: "Recommendations",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_SkillEndorsements_UserSkillUserProfileId_UserSkillSkillId",
                table: "SkillEndorsements",
                columns: new[] { "UserSkillUserProfileId", "UserSkillSkillId" });
